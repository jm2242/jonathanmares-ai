  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none">
        ...
        <p className="text-lg text-[#1a1a1a] dark:text-gray-300 leading-relaxed mb-6">
          Originally from Be'er Sheva, Israel, I grew up in New York and spent my college years at Cornell, studying Chemical Engineering and Computer Science. In my free time, I enjoy playing classical and jazz piano, soccer, mountain biking, motorcycles, and pretending to understand wine. You can find my recordings and performances on my <a href="https://www.instagram.com/therealjonathanmares" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Instagram</a> and <a href="https://www.youtube.com/@jmares93" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Youtube</a> pages.
        </p>
