    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <section>
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-[#111111] dark:text-gray-100">Latest Posts</h2>
          <Link
            href="/blog"
            className="text-[#1a1a1a] dark:text-gray-300 hover:text-[#111111] dark:hover:text-white font-medium transition-colors"
          >
            View all →
          </Link>
        </div>
        ...
        {posts.length === 0 ? (
          ...
          <div className="space-y-6">
            {posts.map((post) => (
              ...
              >
                <h3 className="text-2xl font-semibold mb-2 text-[#111111] dark:text-gray-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                  {post.title}
                </h3>
